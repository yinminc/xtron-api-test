...
parser = require('yargs')
    ...
    .example('$0 -i xtron.apib -o output.html', 'Render to HTML')
    .example('$0 -i xtron.apib -s', 'Start preview server')
    .example('$0 --theme-variables flatly -i xtron.apib -s', 'Theme colors')
    .example('$0 --no-theme-condense-nav -i xtron.apib -s', 'Disable options')
